...
def HTMLTemplate(articleTagg, id=None):
    global topics
    contextUI = ''
    if id != None:
        contextUI = f'''
    ...
    if request.method =="GET":
        ...
        article = f'''
            <form action="/update/{id}/" method="post">
                <p><input type="text" name="title" placeholder="입력하세요^^" value={selectedTopic["title"]}></p>
                <p><textarea name="body" placeholder="이것도 입력하세요~">{selectedTopic['body']}</textarea><p>
                <p><input type="submit"></p>
            </form>
        '''
        return HttpResponse(HTMLTemplate(article, id))
